                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable-books" class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th><c:out value="${bookQuantity}"/></th>
                                        ...
                                        <tr>
											...
											<td><button class="btn btn-default btn-xs" type="button" name="edit" value="${book.id}" onclick="window.location.href='controller?commandName=TO_BOOK_EDIT&num=${book.id}'"><c:out value="${editButton}"/></button>
<!-- 												<form action="controller" method="post"> -->
<!-- 													<input type="hidden" name="commandName" value="TO_BOOK_EDIT" /> -->
<!-- 													<input type="hidden" name="forwardPage" value="book-edit.jsp" /> -->
<%-- 													<input type="hidden" name="num" value="${book.id}" /> --%>
<!-- 													<input type="submit" name="edit" value="Edit" class="btn btn-default btn-xs"/><br/> -->
<!-- 												</form> -->
											</td>
                                        </tr>
                                        </c:forEach>
                                        ...
                                        <%-- <td><button class="btn btn-default btn-xs" type="button" name="edit" value="${book.id}" onclick="window.location.href='book-edit?num=${book.id}'">edit</button></td> --%>
                                    </table>
                                </div>
                            </div>
                        </div>
