...
<html lang="<c:out value="${sessionScope.local}"/>">
    <head>
        ...
        <title><c:out value="${orderListText}"/> – <c:out value="${appName}"/></title>
                                ...
                                <div class="table-responsive m-b-20">
                                    <table id="datatable-status-buttons" class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><c:out value="${order.days}" /></td>
                                            <td><c:out value="${order.date}" /></td>
                                            <td><c:out value="${order.status}" /></td>
                                            <td><button class="btn btn-default btn-xs" type="button" name="edit" value="${order.id}" onclick="window.location.href='controller?commandName=to_order_edit&num=${order.id}'"><c:out value="${editButton}"/></button></td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
